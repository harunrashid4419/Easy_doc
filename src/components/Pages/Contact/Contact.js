...
const Contact = () => {
  ...
  <div className=" px-4 mx-auto max-w-screen-md border-2 border-violet-200 rounded py-12">
      <form action="https://formsubmit.co/munniakter00702@gmail.com" method="POST" className="space-y-8">
          ...
          <button type="submit" className=" py-4 px-5 text-lg btn btn-primary font-medium text-center text-black rounded-lg bg-yellow-500 sm:w-fit hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
          </div>
      </form>
  </div>
</section>
