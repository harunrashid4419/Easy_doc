    ...
    return (
        <div>
            ...
            { code1 && <>
                ...
                {
                    code1 && code1.map((code,i)=><Code code={code} key={i}></Code>)
                }
              </div>
              </>
            }
            ...
            <div className='text-lg md:text-xl my-2'>
                {
                summarytitle2 && summarytitle2.map((summary2)=><p className='my-2'>{summary2}</p>)
                }
            </div>
            </p>
            ...
            { domcode2 && <>
                <div className="mockup-code">
                <pre data-prefix="$"><code>{domcode2}</code></pre> 
              </div>
              </>
            }
            </div>
