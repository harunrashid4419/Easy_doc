...
const QSN = () => {
    return (
        <div>
            <h1 className='text-center text-5xl font-semibold  pt-5'>Frequently Asked Questions</h1>
            <div className='flex flex-col md:flex-row md:justify-between'>
            <div className='flex flex-col  gap-5 md:p-20'>
                <div>
                    <div tabIndex={0} className="collapse collapse-plus border border-base-300 bg-base-100 rounded-md shadow-2xl">
            ...
            <div className='flex flex-col gap-5 md:p-20'>
                <div>
                    <div tabIndex={0} className="collapse collapse-plus border rounded-md shadow-2xl border-base-300 rounded-md shadow-2xl ">
                        <div className="collapse-title text-xl font-medium">
