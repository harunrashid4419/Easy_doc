...
const LeftSideBar = () => {
    ...
    return (
        <div className='shadow-[0_0_40px_0_rgba(0,0,0,0.3)] text-center rounded-lg'>
            ...
            {
                user?.photoURL ?
                    <img className='rounded-full w-20 h-20 mx-auto -mt-12' src="https://i.ibb.co/dJnbzDL/profile-image.png" alt=""></img>
                    :
                    <img src={user?.photoURL} alt="" className='rounded-full w-20 h-20 mx-auto -mt-12' />
            }
