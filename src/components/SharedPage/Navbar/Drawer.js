                ...
                <ul className="menu w-80 bg-base-100 text-base-content text-[1.2rem] space-y-1 px-2">

                    {
                        pathname.includes('/documentation') ?
                            <>
                                <Link className='bg-slate-300 font-bold flex items-center p-2 gap-2' to='/'><FaArrowLeft></FaArrowLeft>back to main menu</Link>

                                <label onClick={() => setOpenInstallation(!openInstallation)}
                                    className="hover:cursor-pointer px-4 py-2 flex items-center hover:bg-gray-300 justify-between">React <FaAngleRight className={`inline text-2xl text-gray-600 ${openInstallation ? 'rotate-90' : ''} transition delay-50 `}></FaAngleRight></label>
                                ...
                                <label onClick={() => setInterviewOpen(!interviewOpen)}
                                    className="hover:cursor-pointer px-4 py-2 flex items-center hover:bg-gray-300 justify-between">Interview Question <FaAngleRight className={`inline text-2xl text-gray-600 ${interviewOpen ? 'rotate-90' : ''} transition delay-50 `}></FaAngleRight></label>
                                ...
                                <label onClick={() => setErrorDocOpen(!errorDocOpen)}
                                    className="hover:cursor-pointer px-4 py-2 flex items-center hover:bg-gray-300 justify-between">Error Handling <FaAngleRight className={`inline text-2xl text-gray-600 ${errorDocOpen ? 'rotate-90' : ''} transition delay-50 `}></FaAngleRight></label>
